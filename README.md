...
- [1. ComfyUI Wildcards](#1-comfyui-wildcards)
  - [1.1. About Wildcards](#11-about-wildcards)
  - [1.2. gkr-wildcards](#12-gkr-wildcards)
    - [1.2.1. Usage](#121-usage)
    - [1.2.2. Availability on CivitAI](#122-availability-on-civitai)
  - [1.3. Wildcards: How To](#13-wildcards-how-to)
- [2. ComfyUI-Workflow](#2-comfyui-workflow)
- [3. SafeTensor Cleaner](#3-safetensor-cleaner)
...
# 3. SafeTensor Cleaner

This folder contains a script to clean SafeTensor files.

See the [SafeTensor-Cleaner/README.md](SafeTensor-Cleaner/README.md) for more information.
